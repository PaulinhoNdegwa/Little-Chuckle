...
class FilterJokes extends Component {
    render() {
        ...
        return (
            <form autoComplete="off" className={`${hideFilters ? `hidden` : ``} flex flex-col bg-indigo-100 px-4 py-3 my-2 max-w-7xl mx-auto sm:flex-row sm:flex-wrap sm:justify-evenly`}>
                {/* <div className="my-1">
